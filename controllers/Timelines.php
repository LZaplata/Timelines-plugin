...
class Timelines extends Controller
{
    ...
    public $requiredPermissions = [
        'lzaplata.timelines.timeline',
    ];

    public function __construct()
    {
        parent::__construct();
        BackendMenu::setContext('LZaplata.Timelines', 'main-menu-item', 'side-menu-item');
    }
    ...
    {
        if (!BackendAuth::userHasAccess("lzaplata.timelines.timeline.create")) {
    ...
    {
        if (!BackendAuth::userHasAccess("lzaplata.timelines.timeline.update")) {
            $content = View::make("backend::access_denied")->render();
